...
""" % (grand["total"], grand["confirmed"], grand["falsified"],
  ...
  <p>The registry is Appendix C of <i>The Coherence Principle</i>, in the Corpus Perspectival
  corpus. The source markdown is vendored into this site at
  ...
  so that the page and the archive cannot drift apart without the build noticing.</p>
